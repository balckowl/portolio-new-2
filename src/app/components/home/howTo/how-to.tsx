...
const HowToList: HowToListType[] = [
    { title: "はじめる", src: "/images/home/hero.png", description: "まずはサイトにログインをしよう" },
    { title: "記事を書く", src: "/images/home/hero.png", description: "挫折した作品についての記事を書こう" },
    { title: "投稿する", src: "/images/home/hero.png", description: "書いた記事を皆に見せよう" },
]
